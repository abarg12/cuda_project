...
# VERIFICATION: executable that compares serial, naive parallel, and optimized parallel code
```
...
# may take a few minutes to run, runs on 10 images in `cuda_project/imgs/ParallelTestData` folder
```
cd sift_parallel/bin
./time_all
```
